...
```{r}
# ==========================================
# Profil klienta kupującego (Persona)
# ==========================================
profil_klienta <- dane2 %>%
  filter(purchased_bike == "Yes") %>%
  summarise(
    Sredni_Wiek = mean(age),
    Mediana_Dochodow = median(income),
    Srednia_Liczba_Aut = mean(cars),
...
kable(profil_klienta, caption = "Profil przeciętnego klienta kupującego rower") %>%
