...
output:
 rmdformats::material:
    highlight: kate          # Kolorowanie składni kodu (inne opcje: tango, pygments, haddock)
    self_contained: true     # Tworzy jeden plik HTML (łatwy do wysłania)
    thumbnails: true         # Miniaturki przy obrazkach
    lightbox: true           # Kliknięcie w obrazek powiększa go
    gallery: true            # Tworzy galerię z wykresów
    cards: true              # Sekcje wyglądają jak "karty" (false = ciągły tekst)
lang: "pl"
---
...
# KLUCZOWE USTAWIENIA - TYLKO WYNIKI, BEZ KODU!
knitr::opts_chunk$set(
  echo = FALSE,       # ❌ UKRYJ KOD
  eval = TRUE,        # ✅ WYKONUJ
  include = TRUE,     # ✅ POKAZUJ WYNIKI
  warning = FALSE,    # ❌ UKRYJ ostrzeżenia
  message = FALSE,    # ❌ UKRYJ komunikaty
  results = 'asis',   # ✅ Tabele HTML
  fig.width = 10,     # Rozmiar wykresów
  fig.height = 6,
  dpi = 300
)
