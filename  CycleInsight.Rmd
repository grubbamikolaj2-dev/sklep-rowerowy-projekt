...
```
Duplikaty występują, ale traktujemy je jako powtarzające się profile klientów (np. kolejne wizyty), dlatego je pozostawiamy.
...
Podsumowanie i wnioski końcowe
Projekt CycleInsight dostarczył pogłębionej, opartej na danych analizy profilu klientów sklepu rowerowego, pozwalając na identyfikację kluczowych determinantów decyzji zakupowych. Przeprowadzony proces badawczy, obejmujący przygotowanie danych, eksploracyjną analizę wizualną oraz zaawansowane modelowanie statystyczne, umożliwił weryfikację postawionych hipotez i sformułowanie praktycznych rekomendacji biznesowych.
...
Podsumowując, idealny klient sklepu rowerowego ("Target Persona") to singiel w wieku 36-45 lat, z wyższym wykształceniem (licencjat), o dochodach 80-100 tys. $, posiadający maksymalnie jeden samochód i zamieszkujący Amerykę Północną. Dla zarządzających oznacza to konieczność przesunięcia akcentów w strategii marketingowej. Kampanie nie powinny być segmentowane według płci czy statusu mieszkaniowego, lecz koncentrować się na benefitach dla osób poszukujących alternatywnego środka transportu (singli, mieszkańców miast) oraz na jakości i prestiżu produktu, trafiając do zamożniejszych, wykształconych konsumentów. Rekomendowane jest również zróżnicowanie oferty i komunikacji między regionami, z uwzględnieniem lokalnych wzorców dojazdów do pracy. Dalsze badania mogłyby uwzględnić czynniki behawioralne, takie jak zainteresowanie aktywnością fizyczną czy dostępność infrastruktury rowerowej, aby jeszcze bardziej udoskonalić prognozowanie popytu i personalizację oferty.
